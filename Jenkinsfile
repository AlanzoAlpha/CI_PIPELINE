pipeline{
        ...
        stages{
		    ...
		    export DATABASE_URI=mysql+pymysql://admin:password@terraform-20201122101422584100000007.cqelbtnl3tpk.eu-west-1.rds.amazonaws.com:3306/users
		    echo "//export TEST_DATABASE_URI=${TEST_DATABASE_URI}"
		    export TEST_DATABASE_URI=mysql+pymysql://admin:password@terraform-20201122101422586800000008.cqelbtnl3tpk.eu-west-1.rds.amazonaws.com:3306/testdb
		    ...
		    mysql -h terraform-20201122101422584100000007.cqelbtnl3tpk.eu-west-1.rds.amazonaws.com -P 3306 -u admin -ppassword < Create.sql
		    mysql -h terraform-20201122101422586800000008.cqelbtnl3tpk.eu-west-1.rds.amazonaws.com -P 3306 -u admin -ppassword < Create.sql
                    cd ..
